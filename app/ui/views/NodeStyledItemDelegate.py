...
class NodeStyledItemDelegate(QStyledItemDelegate):
    ...
    def paint(self, painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex):
        ...
        title_font.setPixelSize(option.font.pixelSize() + 1)

        detail_font = QFont(option.font)
        detail_font.setPixelSize(option.font.pixelSize() - 1)

        small_font = QFont(option.font)
        small_font.setPixelSize(option.font.pixelSize() - 2)
    ...
    def sizeHint(self, option: QStyleOptionViewItem, index: QModelIndex):
        return option.rect.size().expandedTo(QRect(0, 0, 50, 50).size())
